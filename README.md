...
Cream #F5EFE6 — main background color, soft and warm
Clay/Terracotta #C7724A — primary buttons, links, and call-to-action elements
Bark Brown #5C3D2E — headings, navbar, footer
Sage Green #7A9E7E — accents, badges, tags
Warm Gold #C9A84C — highlights, star ratings, special labels
Charcoal #2C2018 — body text
...
Clean product grid layout similar to Etsy
Large hero section on the homepage with a welcome message and featured items
Generous white space so products breathe and stand out
Consistent card design for all product listings

Navigation

Sticky top navbar in Bark Brown with cream text
Logo on the left, links in the center, cart and profile icons on the right
